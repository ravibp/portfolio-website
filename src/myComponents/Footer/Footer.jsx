  ...
  render() {
    return (
      <div className="footer-container row no-gutters">
        <div className="col-12 footer__heading"><h2>LET'S WORK TOGETHER!</h2></div>
        <div className="col-12 col-md-4 footer__contact">
          <h3>CONTACT</h3>
          <p>Phone: 919035804165</p>
          <p>Email: ravibp95@gmail.com</p>
          <ReactContactForm className="email-link" to="ravibp95@gmail.com" />
        </div>
        <div className="col-12 col-md-4 footer__links">
        ...
        <div className="col-12 col-md-4 footer__location">
          <h3>LOCATION</h3>
          <p>Bangalore, India</p>
        </div>
        {/* <div className="col-6">
